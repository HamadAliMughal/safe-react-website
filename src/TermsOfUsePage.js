  ...
  return (
    <div>
      ...
      <div className="text-center">
        <MDBTypography className="text-center display-1 pb-3 mb-3 border">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Qabool Hai.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Qabool Hai, accessible from{" "}
            <a
              href="www.qaboohai.com"
      ...
      <ul>
        <li>
          ...
          <a
            href="www.qaboolhai.com/contactus"
            rel="external nofollow noopener"
            target="_blank"
          >
            www.qaboolhai.com/contactus
          </a>
        </li>
      </ul>
      <Footer />
